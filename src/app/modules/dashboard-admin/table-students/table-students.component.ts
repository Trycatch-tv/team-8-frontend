...
export class TableStudentsComponent  implements OnInit{
  constructor(private studenservice:StudentService, private messageService:MessageService){}
  ...
  ngOnInit(): void {
    this.studenservice.getlist_students().subscribe((data:any) =>{
  ...
  onConfirm1() {
    ...
    this.studenservice.deleteStudent(this.itemId).subscribe((data:any)=>{
    })
